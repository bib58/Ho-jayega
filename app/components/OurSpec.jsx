            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-26'>
                {
                    ourSpecsData.map((spec, index) => {
                        return (
                            <div className='relative py-8 px-8 flex flex-col items-center justify-center w-full text-center border rounded-xl group' style={{ backgroundColor: spec.accent + 10, borderColor: spec.accent + 30 }} key={index}>
